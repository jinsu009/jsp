...
public class PagingVO<T> {
	...
	String blockPattern = "<li class='page-item %1$s'>\r\n"
	...
	public String getPagingHTML() {
		...
		html.append(String.format(blockPattern, liClass, startPage - blockSize, "previous"));
		...
		html.append(String.format(blockPattern, liClass, endPage + 1, "next"));
		html.append("</ul>");
