...
<!-- notnull - required -->
	<tbody>
		<tr>
			<th>prod_id(nn)</th>
			<td>
				<input type="text" name="prod_id" value="${prodvo.prod_id }" placeholder="아이디생성공간" required readonly="readonly"/>
		...
		<tr>
			<th>prod_name(nn)</th>
			<td>
				<input type="text" name="prod_name" value="${prodvo.prod_name }" required  />
		...
		<tr>
			<th>prod_cost(nn)</th>
			<td>
				<input type="text" name="prod_cost"  value="${prodvo.prod_cost }" required  />
		...
		<tr>
			<th>prod_price(nn)</th>
			<td>
				<input type="text" name="prod_price" value="${prodvo.prod_price }" required/>
		...
		<tr>
			<th>prod_sale(nn)</th>
			<td>
				<input type="text" name="prod_sale" value="${prodvo.prod_sale }" required />
		...
		<tr>
			...
			<td>
				<input type="text" name="prod_outline" value="${prodvo.prod_outline }" required />
		...
		<tr>
			...
			<td>
				<input type="text" name="prod_totalstock" value="${prodvo.prod_totalstock }" required />
		...
		<tr>
			...
			<td>
				<input type="text" name="prod_properstock" value="${prodvo.prod_properstock }" required />
