  ...
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
   ...
   <%
		...
		%>
		    ...
		    <a class="py-2 d-none d-md-inline-block" href="<%=request.getContextPath() %>/login/insertMember.do">회원가입</a>
		<%
   		}else{
		%>
		    <a class="py-2 d-none d-md-inline-block" href="<%=request.getContextPath()%>/mypage.do"> <%=authUser.getMem_name() %> 님 </a>
